...
from agents.habit_rl_agents.Habit_Wrapper_Base import Habit_Wrapper_Base
from torch import nn
from numpy.random import choice

class AG_SAC_Wrapper(Habit_Wrapper_Base, SAC_Discrete):
    ...
    def __init__(self, config, end_of_episode_symbol="/"):
        ...
        Habit_Wrapper_Base.__init__(self)
